// tests/ReportGenerator.refactored.test.js

// (Alteração Conforme Instruído )
...
// (Nome do describe alterado para clareza)
describe('ReportGenerator.refactored (Rede de Segurança)', () => {
  ...
  // --- Cenários de USER Padrão (Inalterados) ---
